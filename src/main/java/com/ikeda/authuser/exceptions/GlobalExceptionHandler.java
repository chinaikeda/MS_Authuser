package com.ikeda.authuser.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorRecordResponse> handNotFoundException (NotFoundException ex){
    ...
    public ResponseEntity<ErrorRecordResponse> handValidationExceptions (MethodArgumentNotValidException ex){
